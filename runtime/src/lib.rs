...
pub use rpc::{
    ...
    NftsPallet, OraclePallet, RedeemPallet, ReplacePallet, SecurityPallet, TimestampPallet, UtilFuncs,
...
#[cfg_attr(
    feature = "brooklyn",
    subxt(
        runtime_metadata_path = "metadata_ggx_brooklyn.scale",
...
#[cfg_attr(
    feature = "sydney",
    subxt(
        runtime_metadata_path = "metadata_ggx_sydney.scale",
        derive_for_all_types = "Clone",
        derive_for_type(path = "bitcoin::address::PublicKey", derive = "Eq, PartialEq"),
        derive_for_type(path = "bitcoin::types::H256Le", derive = "Eq, PartialEq"),
        derive_for_type(path = "interbtc_primitives::issue::IssueRequestStatus", derive = "Eq, PartialEq"),
